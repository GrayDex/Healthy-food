...
<div class="catalog-hero__top">
	<h1 class="catalog-hero__title"><?= $arResult['NAME'] ?></h1>
...
<!--<a class="news-content__categories-item --><?php //= $arSection['IS_ACTIVE'] ? 'active' : '' ?><!-- btn-hover_parent no-scale"-->
...
<?php if ($arResult['SECTION_BY_ID'] and count($arResult['SECTION_BY_ID']) > 1): ?>
	...
	<div class="catalog-hero__thumbs">
		<?php foreach ($arResult['SECTION_BY_ID'] as $arSection): ?>
			...
			<div class="catalog-hero__thumbs-item <?= $arSection['IS_ACTIVE'] ? 'active' : '' ?> btn-hover_parent">
...
<section class="catalog-list container section-animation" data-aos="fade-up">
	<div class="catalog-list__inner">
		<?php foreach ($arResult['ITEMS'] as $arItem): ?>
			...
			?>
<!--			<div id="--><?php //= $this->GetEditAreaId($arItem['ID']); ?><!--">-->
				<a class="catalog-card" href="<?= $arItem['~DETAIL_PAGE_URL'] ?>">
...
<!--									<source type="image/webp" srcset="assets/images/catalog-card-img1.webp">-->
						...
						<div class="catalog-card__bot">
							<div class="catalog-card__text"><?= $arItem['PREVIEW_TEXT'] ?></div>
									...
									<div class="catalog-card__plug-info">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											...
											<path d="M13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8Z"
											      fill="#0068FF"></path>
											<rect x="0.5" y="0.5" width="23" height="23" rx="5.5"
											      stroke="#CEDFF5"></rect>
										</svg>
									</div>
								</div>
