			...
			<div class="swiper main-swiper-mobile">
				<?php $APPLICATION->IncludeComponent(
					...
					array(
						...
						"PARENT_SECTION_CODE" => "",
						"PREVIEW_TRUNCATE_LEN" => "",
						"PROPERTY_CODE" => array("", "[IMG_MOBILE]"),
						"SET_BROWSER_TITLE" => "Y",
						"SET_LAST_MODIFIED" => "N",
						"SET_META_DESCRIPTION" => "Y",
						"SET_META_KEYWORDS" => "Y",
...
<section class="main-catalog container" data-aos="fade-up" data-aos-duration="1500">
	...
	<div class="main-catalog__list" data-aos="fade-up" data-aos-duration="1500"><a
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1.webp">
			...
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.webp">
					<img class="picture__img"
					     src="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.png">
				</picture>
			</div>
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2.webp">
			...
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.webp">
					<img class="picture__img"
					     src="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.png">
				</picture>
			</div>
			<div class="main-catalog__item-row">
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3.webp">
			...
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp"
					        srcset="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.webp">
					<img class="picture__img"
					     src="<?= SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.png">
				</picture>
			</div>
			<div class="main-catalog__item-row">
	...
	false
						...
						<!--<a class="swiper-slide main-news__card" href="#">
							<div class="main-news__card-img">
								<picture class="picture">
									<source type="image/webp"
									        srcset="<?php /*= SITE_TEMPLATE_PATH */?>/assets/images/main-news-card1.webp">
									<img class="picture__img"
									     src="<?php /*= SITE_TEMPLATE_PATH */?>/assets/images/main-news-card1.png">
								</picture>
