<div class="popup-filters mobile" data-popup-wrapper="catalog-filters" data-overlay-on>
    ...
    <div class="popup-filters__top">
        ...
        <div class="popup-filters__tops"><label class="catalog-hero__tops" for="top"><input
                        class="catalog-hero__tops-input" type="checkbox" name="top" id="top">
                <div class="catalog-hero__tops-box">
                    <svg class="mark-svg" xmlns="http://www.w3.org/2000/svg" width="14" height="10"
                ...
                <div class="catalog-hero__tops-logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewbox="0 0 40 40" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              fill="#F64653"></path>
                        <path d="M13.511 19.3543L14.0555 21.3864L11.8746 21.9708L13.5878 28.3646L11.3822 28.9556L9.66901 22.5618L7.50056 23.1428L6.95605 21.1107L13.511 19.3543Z"
                              fill="#FFE979"></path>
        ...
        <div class="popup-filters__selects">
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select"><select class="select__select" style="width: 100%"
                                                data-select-placeholder="Бренд">
            ...
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select"><select class="select__select" style="width: 100%"
                                                data-select-placeholder="Жирность">
                            <option value="" selected="selected" disabled="disabled"></option>
...
<section class="catalog-hero top-section container">
    ...
    <div class="catalog-hero__thumbs">
        ...
        <div class="catalog-hero__thumbs-item btn-hover_parent">
            <div class="btn-hover_circle"></div>
            <span>Брикет на вафлях</span>
        </div>
        <div class="catalog-hero__thumbs-item btn-hover_parent">
            <div class="btn-hover_circle"></div>
            <span>Фруктовый и пищевой лёд</span>
        </div>
        <div class="catalog-hero__thumbs-item btn-hover_parent">
            <div class="btn-hover_circle"></div>
            <span>Картонный стакан</span>
        </div>
        <div class="catalog-hero__thumbs-item btn-hover_parent">
            <div class="btn-hover_circle"></div>
            <span>Пластиковый стакан</span>
        </div>
        <div class="catalog-hero__thumbs-item btn-hover_parent">
            <div class="btn-hover_circle"></div>
            <span>Сэндвич</span>
    ...
    <div class="catalog-hero__activity" data-aos="fade-up"><label class="catalog-hero__tops desktop"
                                                                  for="top"><input
        ...
        <div class="catalog-hero__selects">
            ...
            <div class="catalog-hero__select desktop">
                <div class="select-wrapper">
                    <div class="select">
                        <select class="select__select" style="width: 100%" data-select-placeholder="Жирность">
                            <option value="" selected="selected" disabled="disabled"></option>
                            <option value="Жирность1">Жирность1</option>
                            <option value="Жирность2">Жирность2</option>
                        </select>
            ...
            <div class="catalog-hero__filters mobile" data-popup="catalog-filters">
                <div class="catalog-hero__filters-icon">
                    <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.375 9H14.625" stroke="#0068FF" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"></path>
                        <path d="M9 14.625V3.375" stroke="#0068FF" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"></path>
                    </svg>
                </div>
            ...
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select cstm-arrows">
                        <select class="select__select" style="width: 100%"
    ...
    <div class="catalog-list__inner"><a class="catalog-card" href="#">
                ...
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img1.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img1.png">
                        </picture>
                    </div>
                            ...
                            <div class="catalog-card__plug-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24"
                                    ...
                                    <path d="M9.92963 2.48L4.58963 5.45003C3.37963 6.12003 2.38965 7.80001 2.38965 9.18001V14.83C2.38965 16.21 3.37963 17.89 4.58963 18.56L9.92963 21.53C11.0696 22.16 12.9396 22.16 14.0796 21.53L19.4196 18.56C20.6296 17.89 21.6196 16.21 21.6196 14.83V9.18001C21.6196 7.80001 20.6296 6.12003 19.4196 5.45003L14.0796 2.48C12.9296 1.84 11.0696 1.84 9.92963 2.48Z"
                                          fill="#0068FF"></path>
                                    <path d="M3.16992 7.43994L11.9999 12.5499L20.7699 7.46991" stroke="#EAF3FF"
                                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M12 21.61V12.54" stroke="#EAF3FF" stroke-width="1.5"
                                          stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M16.9998 13.2401V9.58014L7.50977 4.1001" stroke="#EAF3FF"
                                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>
                            ...
                            <div class="catalog-card__plug-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24"
                                    ...
                                    <g clip-path="url(#clip0_758_8108)">
                                        <path d="M2.99999 18.9995C2.446 18.9995 2 19.4455 2 19.9995V21.9995C2 22.5535 2.446 22.9995 2.99999 22.9995H4.99997C5.55397 22.9995 5.99996 22.5535 5.99996 21.9995V20.9995H9.99993V21.9995C9.99993 22.5535 10.4459 22.9995 10.9999 22.9995H12.9999C13.5539 22.9995 13.9999 22.5535 13.9999 21.9995V20.9995H17.9999V21.9995C17.9999 22.5535 18.4459 22.9995 18.9998 22.9995H20.9998C21.5538 22.9995 21.9998 22.5535 21.9998 21.9995V19.9995C21.9998 19.4455 21.5538 18.9995 20.9998 18.9995H2.99999Z"
                                              fill="#0068FF"></path>
                                        <rect x="3.00098" y="10" width="7.99993" height="7.99993" rx="1"
                                              fill="#0068FF"></rect>
                                        <path d="M6.5 13C6.5 13.2761 6.72386 13.5 7 13.5C7.27614 13.5 7.5 13.2761 7.5 13H6.5ZM6.5 10V13H7.5V10H6.5Z"
                                              fill="#EAF3FF"></path>
                                        <rect x="13" y="10" width="7.99993" height="7.99993" rx="1"
                                              fill="#0068FF"></rect>
                                        <path d="M16.5 13C16.5 13.2761 16.7239 13.5 17 13.5C17.2761 13.5 17.5 13.2761 17.5 13H16.5ZM16.5 10V13H17.5V10H16.5Z"
                                              fill="#EAF3FF"></path>
                                        <rect x="8" y="1" width="7.99993" height="7.99993" rx="1"
                                              fill="#0068FF"></rect>
                                        <path d="M11.5 3.99997C11.5 4.27612 11.7239 4.49997 12 4.49997C12.2761 4.49997 12.5 4.27612 12.5 3.99997H11.5ZM11.5 1V3.99997H12.5V1H11.5Z"
                                              fill="#EAF3FF"></path>
                                    </g>
                                    <defs>
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img2.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img2.png">
                        </picture>
                    </div>
                    <div class="catalog-card__title">22 копейки</div>
                </div>
                <div class="catalog-card__bot">
                    <div class="catalog-card__text">Пломбир в шоколадной глазури с арахисом в вафельном стаканчике
                    </div>
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
                            <div class="catalog-card__plug-icon">
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img3.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img3.png">
                        </picture>
                    </div>
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img4.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img4.png">
                        </picture>
                    </div>
                    <div class="catalog-card__title">Сёмыч за Сочи</div>
                </div>
                <div class="catalog-card__bot">
                    <div class="catalog-card__text">Мороженое пломбир с фруктовым наполнителем «Клубника» в
                        вафельном сахарном рожке с &quot;Шоколадной&quot; глазурью.
                    </div>
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
                            <div class="catalog-card__plug-icon">
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img5.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img5.png">
                        </picture>
                    </div>
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img6.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img6.png">
                        </picture>
                    </div>
                    <div class="catalog-card__title">Карамельная косичка</div>
                </div>
                <div class="catalog-card__bot">
                    <div class="catalog-card__text">Мороженое с заменителем молочного жира двухслойное с ароматом
                        ванили и вкусом карамели с мягкой карамелью
                    </div>
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
                            <div class="catalog-card__plug-icon">
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img7.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img7.png">
                        </picture>
                    </div>
                    <div class="catalog-card__title">Сливочное лакомство</div>
                </div>
                <div class="catalog-card__bot">
                    <div class="catalog-card__text">Мороженое сливочное во взбитой шоколадной сливочной глазури
                    </div>
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
                            <div class="catalog-card__plug-icon">
            ...
            <div class="catalog-card__inner">
                <div class="catalog-card__top">
                    <div class="catalog-card__img">
                        <picture class="picture">
                            <source type="image/webp" srcset="assets/images/catalog-card-img8.webp">
                            <img class="picture__img" src="assets/images/catalog-card-img8.png">
                        </picture>
                    </div>
                    <div class="catalog-card__title">Варежка</div>
                </div>
                <div class="catalog-card__bot">
                    <div class="catalog-card__text">Мороженое эскимо пломбир ванильный в шоколадной глазури с
                        арахисом
                    </div>
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
