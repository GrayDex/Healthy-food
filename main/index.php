...
$APPLICATION->SetTitle("Главная"); ?>
    ...
    <?php require($_SERVER["DOCUMENT_ROOT"] . "/main/include/templ/slider.php"); ?>
        ...
        <div class="container" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="main-traditions__video" data-button-fade="main-video">
                <div class="main-traditions__video-bg">
                    <svg width="1840" height="700" viewbox="0 0 1840 700" fill="none"
                ...
                <div class="main-traditions__video-video">
                    <video src="/main/assets/videos/zp_preview.mp4" loop muted playsinline autoplay
                           preload="none"></video>
                </div>
                ...
                <div class="main-news__slider-wrapper">
                    <div class="swiper main-news__swiper">
                        <div class="swiper-wrapper"><a class="swiper-slide main-news__card" href="#">
                                ...
                                <p class="main-news__card-title">Диетолог Снегирева рассказала, как выбрать правильное
                                    мороженое</p>
