<section class="top-section container">
    <div class="breadcrumbs">
        <div class="breadcrumbs-wrapper">
            <div class="breadcrumbs-wrapper__row">
                ...
                <a class="breadcrumbs__item" href="/news/index.php">новости и акции</a>
                <div class="breadcrumbs__arrow">
                    <svg width="9" height="14" viewbox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.501732 0.71693C0.688798 2.76241 1.82258 7.06302 8.00226 7.42407C8.43495 7.44882 8.66756 6.9815 8.3585 6.70488L1.3053 0.390819C0.992979 0.109838 0.465946 0.325304 0.501732 0.71693Z"
                              fill="#F64653"></path>
                ...
                <div class="breadcrumbs__current active">Диетолог Снегирева рассказала, как выбрать правильное
                    мороженое
                </div>
            </div>
        </div>
    ...
    <section class="news-detail">
        <div class="news-detail__top">
            <h2 class="news-detail__title">Диетолог Снегирева рассказала, как выбрать правильное мороженое</h2>
        ...
        <div class="news-detail__time">
            <div class="news-detail__date">6 марта 2023</div>
        ...
        <div class="news-detail__content" data-aos="fade-up">
            ...
            <p>Важно, чтобы в составе <strong>мороженого не было растительных</strong>жиров. Однако наличие различных
            ...
            <p>Однако наличие <u>различных стабилизаторов в составе</u>&nbsp;не стоит вызывать беспокойство, так как они
